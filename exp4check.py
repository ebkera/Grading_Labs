...
questions.append([6,"(8)","Check that '$\\Tau$ measured' value is equal to 1/C, where C is their fit parameter found in (7)",2])#qnum:10
questions.append([7,"($\\bullet$)","Check agreement (4) to (6)",2])#qnum:11
questions.append([7,"(8)","Check that '$\\Tau$ measured' value is equal to 1/C, where C is their fit parameter found in (7)",2])#qnum:12
...
questions.append([10,"(4)","Check that '$\\Tau$ measured' value is equal to 1/C, where C is their fit parameter found in (7)",1])#qnum:19
...
ExplanationOptions=[["From Text Field","The first line for index purposes","Q1"], #JUst the first line
					 ...
					 ["From Text Field","There should agreement between (4)-(6)"], #Q11
					 ...
					 ["From Text Field","The station was not clean. Remember that you get a lot of points for keeping you station just the way you found it","Q3"]] #Q28
